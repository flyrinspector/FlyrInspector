...
// -------------------- OLVIDASTE TU CONTRASEÑA (mostrar/ocultar vista) --------------------
...
// Abrir directamente la vista de recuperación si llega con #forgot
...
document.getElementById("forgot-password-form")?.addEventListener("submit", async (e) => {
  ...
  try {
    const { error } = await supabase.auth.resetPasswordForEmail(email, {
      // Asegúrate de registrar esta URL en Supabase → Redirect URLs
